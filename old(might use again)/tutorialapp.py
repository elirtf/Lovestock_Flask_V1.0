...
# from Lovestock.auth.auth import login_required
# from Lovestock.tutorialdb import get_db
#
...
# #
# #     if stock_data:
# #         return render_template('templatemixed.html', stock=stock_data, symbol=symbol)
# #     else:
